...
class ApiApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     */
     enum class FormatApiSchemaRetrieve(val value: kotlin.String) {
     ...
     */
     enum class LangApiSchemaRetrieve(val value: kotlin.String) {
         @Json(name = "af") af("af"),
         @Json(name = "ar") ar("ar"),
    ...
    fun apiSchemaRetrieve(format: FormatApiSchemaRetrieve? = null, lang: LangApiSchemaRetrieve? = null) : kotlin.collections.Map<kotlin.String, kotlin.Any> {
        val localVarResponse = apiSchemaRetrieveWithHttpInfo(format = format, lang = lang)
    ...
    fun apiSchemaRetrieveWithHttpInfo(format: FormatApiSchemaRetrieve?, lang: LangApiSchemaRetrieve?) : ApiResponse<kotlin.collections.Map<kotlin.String, kotlin.Any>?> {
     ...
     */
    fun apiSchemaRetrieveRequestConfig(format: FormatApiSchemaRetrieve?, lang: LangApiSchemaRetrieve?) : RequestConfig<Unit> {
